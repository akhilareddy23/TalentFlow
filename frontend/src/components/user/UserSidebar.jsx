  ...
  return (
    ...
    >
      ...
      <div className="px-6 pt-7 pb-6 border-b border-white/10">
        <div className="flex items-center space-x-2.5">
          ...
          <div>
            ...
            <p className="text-[10px] text-white/40 font-medium tracking-widest uppercase mt-0.5">AI Platform</p>
          </div>
        </div>
      </div>
      ...
      <nav className="flex-1 px-4 pt-6 space-y-1.5">
        <p className="text-[10px] font-semibold uppercase tracking-widest text-white/30 px-2 mb-3">Menu</p>
        {navItems.map((item) => {
